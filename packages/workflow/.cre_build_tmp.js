...
var SYSTEM_PROMPT = `You are an adversarial trial system that determines the outcome of prediction market questions through structured debate.
...
var USER_PROMPT = `Run an adversarial trial for this prediction market question and return your verdict as JSON:

{"result": "YES" or "NO", "confidence": <integer 0-10000>}

Question: `;
function askAnthropic(runtime2, question) {
  runtime2.log("[Trial] Running adversarial trial via Anthropic...");
  const apiKey = runtime2.getSecret({ id: "ANTHROPIC_API_KEY" }).result();
  const httpClient = new cre.capabilities.HTTPClient;
  const result = httpClient.sendRequest(runtime2, buildAnthropicRequest(question, apiKey.value), consensusIdenticalAggregation())(runtime2.config).result();
  runtime2.log(`[Trial] Response: ${result.response}`);
  return result;
}
var buildAnthropicRequest = (question, apiKey) => (sendRequester, config) => {
  const requestData = {
...
function onLogTrigger(runtime2, log) {
  runtime2.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  runtime2.log("TrialByFire CRE Workflow: Settlement Trial");
  runtime2.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  try {
    ...
    runtime2.log("[Step 2] Running adversarial trial via Anthropic...");
    const trialResult = askAnthropic(runtime2, question);
    ...
    runtime2.log(`[Step 2] Verdict: ${parsed.result}`);
    runtime2.log(`[Step 2] Confidence: ${parsed.confidence / 100}%`);
    const outcomeValue = parsed.result === "YES" ? 0 : 1;
    runtime2.log("[Step 3] Generating settlement report...");
    ...
    runtime2.log(`[Step 3] Writing to contract: ${evmConfig.marketAddress}`);
    ...
    if (writeResult.txStatus === TxStatus.SUCCESS) {
      ...
      runtime2.log(`[Step 3] Settlement successful: ${txHash}`);
      runtime2.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
